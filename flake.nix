{
  ...
  inputs = {
    ...
    # CHANGE THE LINK TO THE MASTER AFTER THE CHANGES APPLY, THIS IS ONLY TO ENSURE ITS WORK; REMEMBER JAOLEAL!!!!
    floresta-master.url = "github:jaoleal/floresta/more-flake-checks"; # Using the latest nix expressions
